            ...
            <div class="lot-item__content">
                <div class="lot-item__left">
                    <div class="lot-item__image">
                        <img src="../img/<?=$lot['image'];?>" width="730" height="548" alt="<?=$lot['name_lot'];?>">
                    </div>
                    ...
                    <div class="lot-item__state">
                        ...
                        <div class="lot-item__cost-state">
                            <div class="lot-item__rate">
                                ...
                                <span class="lot-item__cost"><?=adding_ruble($lot['initial_price']);?></span>
                            </div>
                            <div class="lot-item__min-cost">
                                Мин. ставка <span><?=adding_ruble($lot['step_rate']);?></span>
                            </div>12 000 р
                        </div>
                        <form class="lot-item__form" action="https://echo.htmlacademy.ru" method="post" autocomplete="off">
                            <p class="lot-item__form-item form__item form__item--invalid">
                                <label for="cost">Ваша ставка</label>
                                <input id="cost" type="text" name="cost" placeholder="<?=adding_ruble($lot['step_rate']);?>">
